                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('books.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('author') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="author" value="{{ old('author', $author) }}" required>
                        ...
                        <div class="form-group{{ $errors->has('isbn13') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="isbn13" value="{{ old('isbn13', $isbn13) }}" pattern="^\d*$" title="13 digit ISBN.">
